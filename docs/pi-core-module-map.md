...
状态：MVP 核心路径已完成逐模块核对（Pi 基线 `0.82.1`, commit `cced6a21da273b26ee4a23a803680614bbe8dd1e`）；Phase 1–8 全部完成（8/8，与 `docs/porting-plan.md` 一致），release hardening 进行中（Batch 1 已完成、Batch 2A 进行中，见 `docs/release-hardening-plan.md` 与 `docs/macos-signing.md`），Pi extension 运行时已停用。
